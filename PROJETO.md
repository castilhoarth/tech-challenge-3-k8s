...
> Estes valores foram extraídos diretamente do relatório de billing da AWS (arquivo CSV). Eles representam o uso histórico de serviços como EC2, RDS, S3, Secrets Manager, ELB e EKS, dentro do contexto da pesquisa de pós-graduação.
